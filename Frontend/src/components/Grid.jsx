  ...
  return (
    <div className='md:min-h-[90%] p-0 lg:p-8 md:mt-0 mt-60'>
        ...
        <div className='relative z-10 pt-6 text-center'>
            ...
            mb-28'style={{textShadow : "0 0 10px rgba(255 , 255, 255 , 0.7) , 0 0 20px rgba(167 , 139 , 250 , 0.5)"}}> 
                These are Our Innovations
            </h1>
        </div>
        ...
        md:grid-cols-3 gap-4 md:gap-6'>
            ...
            <div className='md:col-span-1 space-y-4 md:space-y-6'>
                ...
                transition-transform duration-300 hover:scale-105'>
                    {/* card Backgroud with gradient */}

                    <div className='absolute h-full w-full'>

                        <img src="/public/images/bento-card1.png"
                         alt="card 1" />
            ...
            <div className='md:col-span-2 space-y-4 md:space-y-6'>
              ...
              md:gap-6'>
                ...
                {/*card 3 - forst small card  */}

            <div className=' relative overflow-hidden rounded-3xl border
            border-white aspect-square tranform tranisition-tranform duration-300
            hover:scale-105'>
            ...
            <h1 className='absolute bottom-2 left-1/2 transform -translate-x-1/2
            z-10 font-extrabold text-2xl'>Scoriox</h1>
            ...
            <h1 className='absolute bottom-2 left-1/2 transform -translate-x-1/2
            z-10 font-extrabold text-2xl'>Floralynx</h1>
            ...
            <h1 className='absolute bottom-2 left-1/2 transform -translate-x-1/2
            z-10 font-extrabold text-2xl'>Titanor</h1>
            ...
            <div className='relative overflow-hidden rounded-3xl border border-white sapect-[16/9]
            md:col-span-2 transform transition-all duration-300 hover:scale-[1.02]'>
